...
<body class="body-bg">
      ...
      <div class="container">
         ...
         <div class="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
            <div class="navbar-nav">
               ...
               <a class="nav-link active" href="{{ route('makanan') }}">Makanan</a>
   ...
   {{-- section makanan --}}
   <section class="section-makanan pb-5" id="makanan">
      <div class="container">
         <h2 class="text-center mt-4 mb-2 title">Makanan di Desa Kaliprau</h2>
         <p class="text-center mb-5">Temukan Tempat menarik dan mempesona di desa kaliprau</p>
         <div class="row justify-content-center">
            @foreach ($items as $item)
               <div class="col-lg-6 d-flex">
                  <div class="card mb-4 flex-grow-1" style="max-width: 1000px;">
                     <div class="row g-0">
                        <div class="col-md-4">
                           <img src="{{ Storage::url($item->image) }}"
                              style="max-height: 220px ;width:700px;object-fit:cover"
                              class="img-fluid rounded-start contain" alt="...">
                        </div>
                        <div class="col-md-8">
